...
class EmailSender:
    ...
    def send_reset_password_email(to_email: str, token: str):
        msg = EmailMessage()
        msg['Subject'] = "Reset your Monster IA password"
        msg['From'] = BASI_EMAIL
        msg['To'] = to_email
        ...
        If you want to change your account ({to_email}) password, copy and paste this link into your browser:
        {activation_link}
            
        The link is valid for 24 hours.
        If you didn't change your password, simply ignore this message.
        """)
        ...
        <!DOCTYPE html>
            ...
            <body style="font-family: Arial, sans-serif; background-color: #f4f5f7; padding: 20px; margin: 0;">
                <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <p style="color: #555555; font-size: 16px; line-height: 1.5;">Hello,</p>
                    <p style="color: #555555; font-size: 16px; line-height: 1.5;">
                        To change your password and start using the app, please click the button below:
                    </p>
