...
def main():
    ...
    parser.add_argument("--data-dir", default="dataset/data", help="Path to data directory with train/ and val/")
    ...
    parser.add_argument("--out", default="monster_model_ts.pt")
    ...
    for epoch in range(args.epochs):
        ...
        for phase in ["train","val"]:
            ...
            if phase=="val" and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_wts = copy.deepcopy(model.state_dict())
                torch.save({'model_state': best_wts, 'classes': classes}, "best_model.pth")
        scheduler.step()
    ...
    torch.save(model.state_dict(), "monster_resnet_state_dict.pth")
